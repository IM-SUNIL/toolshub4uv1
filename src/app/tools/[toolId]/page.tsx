...
import { getToolById, getRelatedTools, renderStars, type Tool } from '@/lib/data/tools'; // Import mock data and helpers
...
const ToolDetailPage: NextPage = () => {
  const params = useParams();
  const router = useRouter();
  const toolId = params.toolId as string; // Get toolId from URL parameters
  ...
  return (
    <div className="container mx-auto px-4 py-8 pt-14 md:pt-16 max-w-6xl"> {/* Adjusted padding-top */}
       {/* Breadcrumbs */}
        ...
        <div className="flex flex-col justify-center space-y-3 md:space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
             <Badge variant="secondary" className="text-sm py-1 px-3 flex items-center gap-1">
               <tool.categoryIcon className="h-4 w-4"/> {tool.category}
             </Badge>
          ...
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
           ...
           <Button size="lg" className="mt-4 w-full sm:w-auto group transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:shadow-accent/30">
                        ...
                        <Card className="h-full bg-card hover:border-accent transition-colors duration-300 transform hover:-translate-y-1 hover:shadow-xl cursor-pointer flex flex-col">
                            ...
                            <CardHeader className="flex-shrink-0 pb-2 pt-4 px-4">
                                <div className="flex items-center gap-2 mb-1">
                                    <relatedTool.categoryIcon className="h-4 w-4 text-accent flex-shrink-0" />
