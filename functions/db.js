...
//    - Local: Set in functions/.env file
//    - Deployment: Set using `firebase functions:config:set mongodb.uri="mongodb+srv://..."` OR set as runtime environment variable in GCP.
...
if (!mongoUri) {
  ...
  console.error('For local development, add MONGODB_URI="mongodb+srv://imrajputsunil:PASSWORD@cluster0..." to the functions/.env file.');
  console.error('For deployment, set the secret using `firebase functions:config:set mongodb.uri="mongodb+srv://imrajputsunil:PASSWORD@cluster0..."` (replace PASSWORD with your actual password, ensuring special characters like @ are URL-encoded, e.g., Rajput%40689).');
